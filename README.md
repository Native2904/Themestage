...
- Alt+Enter shows a native, dark-styled theme dashboard with all color codes, color cards, and contrast ratings (AA/AA Large/Fail) against the background
...
See [ThemeStage-Getting-Started.md](ThemeStage-Getting-Started.md) for a detailed step-by-step guide, including where to download new themes.
...
- Alt+Enter zeigt ein natives, dunkel gestaltetes Theme-Dashboard mit allen Farbcodes, Farbkarten und Kontrast-Bewertung (AA/AA Large/Fail) gegen den Hintergrund
